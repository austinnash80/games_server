User.destroy_all
u1 = User.create :name => 'Austin', :player => true, :sherpa => false, :location => 'Bondi', :available => 'Friday'
u2 = User.create :name => 'Ivor', :player => false, :sherpa => true, :location => 'Manly', :available => 'Sunday'
...
Event.destroy_all
e1 = Event.create :date => Date.parse("09-01-2018"), :time => Time.parse("17:00"), :location => '333 George St', :user => u1, :game => g1
e2 = Event.create :date => Date.parse("10-02-2018"), :time => Time.parse("16:00"), :location => '333 Market St', :user => u1, :game => g1
e3 = Event.create :date => Date.parse("11-02-2018"), :time => Time.parse("15:00"), :location => '333 King St', :user => u2, :game => g2
